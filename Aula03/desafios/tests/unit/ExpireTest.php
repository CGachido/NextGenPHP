...
final class ExpireTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testExpiresShouldThrowInvalidMethodExceptionWhenReciveInvalidMethod()
    {
        $this->expectException(IntervalMethodNotFoundException::class);
        $this->expectExceptionMessage("Method 'day' does not exists");
        $this->expires->day(1);
    }

    public function testExpiresShouldThrowInvalidArgumentWhenReciveNegativeNumber()
    {
        $this->expectException(InvalidArgumentException::class);
